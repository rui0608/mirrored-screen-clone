    ...
    <div className="app-container">
      ...
      <main className="main-content company-content">
        <div className="company-info-content">
          ...
          <p>・代表理事　尾上 浩一　（日本PTA元会長・第7,8期中央審議会委員）</p>
          <p>・設立　令和3年3月3日</p>
          <p>・設立趣旨</p>
          ...
          <p>・事業内容</p>
          <p className="company-paragraph">１・公益社団法人日本PTA全国協議会、府省庁、社会教育団体などとの連携、協議による収益事業</p>
          <p className="company-paragraph">２・収益によるPTAなどの活動支援</p>
          <p className="company-indent">（全国協議会、各ブロック協議会、都道府県・政令市PTA連合会・協議会・区市町村PTA・単位PTA）</p>
          <p>・システム開発・運用サポート</p>
          <p className="company-paragraph">株式会社ワンリーリステッド</p>
