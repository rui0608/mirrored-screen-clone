      ...
      <main className="main-content company-content">
        <div className="card company-card">
          <div className="company-info">
            ...
            <p>・設立　令和3年3月3日</p>
            <p>・設立趣旨</p>
            <p className="indent">公益社団法人日本PTA全国協議会様（会員数：約750万世帯）と業務委託・包括的協定を締結することにより、協議会・連合PTAとの連携を強化するために各収益事業などを行う。</p>
            <p className="indent">また、全国のPTA活動や学校を支援し、社会教育および生涯教育の一助を担い、児童・生徒の健全育成のためのPTA活動の充実および学校支援を行う。</p>
            <p>・事業内容</p>
            <p className="indent">１・公益社団法人日本PTA全国協議会、府省庁、社会教育団体などとの連携、協議による収益事業</p>
            <p className="indent">２・取諾によるPTAなどの活動支援</p>
            <p className="indent">　（全国協議会、各ブロック協議会、都道府県・政令市PTA連合会・協議会・区市町村PTA・単位PTA）</p>
            <p>・システム開発・運用サポート</p>
            <p>株式会社ワンリーリステッド</p>
